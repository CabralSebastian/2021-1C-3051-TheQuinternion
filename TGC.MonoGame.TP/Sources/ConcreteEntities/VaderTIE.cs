...
{
    internal class VaderTIE : DynamicEntity, IStaticDamageable, ILaserDamageable
    {
        protected override Drawer Drawer() => TGCGame.content.D_VaderTIE;

        protected override Vector3 Scale => Vector3.One / 100f;
        protected override TypedIndex Shape => TGCGame.content.SH_VaderTIE;
        ...
        protected float StandarVelocity = 200f;
